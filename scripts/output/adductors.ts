  ...
  exercises: [
    {
      ...
      muscles: ['Adductors', 'Glutes', 'Hamstrings'],
      alternatives: [
        'adductors-3',
        'adductors-2',
        'adductors-4',
    ...
    },
    {
      ...
      description:
        'The alternating lateral lunge with overhead reach is a warm-up exercise used to dynamically stretch the lower body, shoulders, and upper back. The stretch primarily increases mobility in the groin, but will also be felt in the shoulders. Warming up adequately is an important part of any workout routine, and maintaining mobility can increase the overall effectiveness of certain exercises.',
      targetBodyParts: ['Adductors'],
      exerciseType: ['warmup'],
      difficulty: 'beginner',
      ...
      muscles: ['Adductors', 'Calves', 'Hamstrings', 'Shoulders', 'Upper Back'],
      alternatives: [
        'adductors-5',
        'adductors-6',
        'adductors-4',
    ...
    },
    {
      ...
      mechanics: 'Isolation',
      videoUrl:
        'https://player.vimeo.com/video/760008232?badge=0&autopause=0&player_id=0&app_id=58479',
      imageUrl:
        'https://cdn.muscleandstrength.com/sites/all/themes/mnsnew/images/taxonomy/exercises/muscle-groups/full/Adductors.jpg',
      viewCount: 18700,
      popularity: 'low',
    },
    {
      ...
      muscles: ['Adductors', 'Glutes', 'Hamstrings', 'Hip Flexors', 'Quads'],
      alternatives: [
        'adductors-2',
        'adductors-5',
        'adductors-6',
    ...
    },
    {
      ...
      description:
        'The lateral kneeling adductor mobilization drill is a form of dynamic stretching and an exercise used to alleviate tension in the adductors. Ensuring you’re properly warmed up is important for maximizing your time in the gym and avoiding injury.',
      targetBodyParts: ['Adductors'],
      exerciseType: ['warmup'],
      difficulty: 'beginner',
      equipment: ['Bodyweight'],
    ...
    },
    {
      ...
      muscles: ['Adductors', 'Shoulders', 'Upper Back'],
      alternatives: [
        'adductors-2',
        'adductors-5',
        'adductors-4',
