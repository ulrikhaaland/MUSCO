...
// Source: https://www.muscleandstrength.com/exercises/abductors.html
// Total exercises: 2
// Generated on: 2025-03-08T09:04:44.159Z

export const abductorsExercises: ExerciseGroup = {
  bodyPart: 'Abductors',
  exercises: [
    {
      id: 'abductors-1',
      ...
      description:
        'The hip abduction machine exercise is an exercise used to strengthen the abductors. The abductors play a critical role in core stability and having strong abductors can result in better personal records on the squat and deadlift. From an aesthetic perspective, performing hip abduction isolation exercises assists in the development of a full pair of glutes and hips.',
      targetBodyParts: ['Abductors'],
      ...
      muscles: ['Abductors', 'Abs', 'Glutes', 'Hamstrings'],
      alternatives: ['abductors-2'],
      repetitions: 12,
      sets: 3,
      restBetweenSets: 60,
      forceType: 'Push (Bilateral)',
      mechanics: 'Isolation',
      videoUrl: 'https://www.youtube.com/embed/7pbZA7ncuq8?rel=0',
      imageUrl:
    ...
    },
    {
      ...
      mechanics: 'Isolation',
      videoUrl:
        'https://player.vimeo.com/video/760008214?badge=0&autopause=0&player_id=0&app_id=58479',
      imageUrl:
        'https://cdn.muscleandstrength.com/sites/all/themes/mnsnew/images/taxonomy/exercises/muscle-groups/full/Abductors.jpg',
      viewCount: 85600,
      popularity: 'low',
