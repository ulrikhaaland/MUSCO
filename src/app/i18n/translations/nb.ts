...
const translations = {
  ...
  'exerciseProgram.overview.title.recovery': 'Personlig tilpasset for din restitusjon',
  ...
  'exerciseProgram.nextWeekCard.description': 'Del din tilbakemelding om denne ukens øvelser for å få ditt personlige program for neste uke',
