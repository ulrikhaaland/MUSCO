...
const translations = {
  ...
  'profile.modality.recovery': 'Restitusjon',
  'profile.modality.recovery.description':
    'Tøying, yoga, mobilitetsarbeid, aktiv restitusjon',
  ...
  'program.optionalRecovery': 'Valgfrie restitusjonsaktiviteter',
  'program.recoveryMessage':
    'Disse skånsomme øvelsene kan utføres hjemme for å hjelpe restitusjon. Lytt til kroppen din og gjør bare det som føles behagelig.',
  ...
  'programs.filter.recovery': 'Restitusjon',
  ...
  'exerciseProgram.dayAbbr.tue': 'Tir',
  'exerciseProgram.dayAbbr.wed': 'Ons',
  'exerciseProgram.dayAbbr.thu': 'Tor',
  'exerciseProgram.dayAbbr.fri': 'Fre',
