...
const translations = {
  ...
  'bottomSheet.chooseBodyPart': 'Velg kroppsdelen du vil fokusere på for restitusjon',
  ...
  'bottomSheet.tourHeader': 'Her kan du se den valgte kroppsgruppen, og rett under den, den valgte kroppsdelen.',
  'bottomSheet.tourReset': 'Bruk denne knappen for å tilbakestille chatten og starte på nytt.',
  'bottomSheet.tourSuggestions': 'Klikk på foreslåtte spørsmål for å lære mer om den valgte kroppsdelen.',
  'bottomSheet.tourInput': 'Skriv inn dine spørsmål her for å lære mer om anatomi, øvelser og behandlingsalternativer.',
  'bottomSheet.tourControls': 'Bruk disse knappene for å utvide eller minimere chatteområdet.',
  'bottomSheet.tourRotate': 'Bruk denne knappen for å rotere 3D-modellen.',
  'bottomSheet.tourResetModel': 'Bruk denne knappen for å tilbakestille 3D-modellen til utgangspunktet.',
  'bottomSheet.tourGender': 'Bruk denne knappen for å bytte mellom mannlig og kvinnelig 3D-modell.',
  
  // Tour steps
  'tour.bodyGroup': 'Her kan du se den valgte kroppsgruppen, og rett under den, den valgte kroppsdelen.',
  'tour.resetButton': 'Bruk denne knappen for å nullstille chatten og starte på nytt.',
  'tour.suggestedQuestions': 'Klikk på foreslåtte spørsmål for å lære mer om den valgte kroppsdelen.',
  'tour.askQuestions': 'Skriv inn dine spørsmål her for å lære mer om anatomi, øvelser og behandlingsalternativer.',
  'tour.expandButtons': 'Bruk disse knappene for å utvide eller minimere chatteområdet.',
  ...
  'profile.modality.recovery.description': 'Tøying, yoga, mobilitetsarbeid, aktiv restitusjon',
  ...
  'program.recoveryMessage': 'Disse skånsomme øvelsene kan utføres hjemme for å hjelpe restitusjon. Lytt til kroppen din og gjør bare det som føles behagelig.',
  ...
  bottomSheet: {
    ...
    back: '← Tilbake',
    gotIt: 'Forstått',
    tourStep1: 'Her kan du se den valgte kroppsgruppen, og rett under den, den valgte kroppsdelen.',
    tourStep2: 'Bruk denne knappen for å tilbakestille chatten og starte på nytt.',
    tourStep3: 'Klikk på foreslåtte spørsmål for å lære mer om den valgte kroppsdelen.',
    tourStep4: 'Skriv dine spørsmål her for å lære mer om anatomi, øvelser og behandlingsalternativer.',
