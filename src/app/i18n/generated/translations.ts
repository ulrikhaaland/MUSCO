...
export const generatedTranslations = {
  "en": {
    ...
    "flutter.modelViewer.chat.programGenerationUnsupported": "Program generation flow is not wired in Flutter yet (programType={{programType}}).",
    "flutter.modelViewer.chat.quickPromptIntro": "Start with a quick prompt or ask your own question.",
    "flutter.modelViewer.chat.tapToOpenChat": "Tap to open chat",
    "flutter.modelViewer.history.stubReady": "History panel is ready. Next step: connect persisted chat sessions.",
    "flutter.modelViewer.quickPrompt.recovery.label": "Recovery tips",
    "flutter.modelViewer.quickPrompt.recovery.message": "Give me quick recovery tips for this area.",
    "flutter.modelViewer.quickPrompt.trainArea.label": "How to train this?",
    "flutter.modelViewer.quickPrompt.trainArea.message": "How should I train this area?",
    "flutter.modelViewer.quickPrompt.whyHurt.label": "Why does this hurt?",
    "flutter.modelViewer.quickPrompt.whyHurt.message": "Why does this hurt?",
    "flutter.modelViewer.status.gettingReady": "Getting things ready",
    "flutter.modelViewer.status.loadError": "Could not load model. Please try again.",
    "flutter.modelViewer.status.loadingModel": "Loading anatomy model",
    "flutter.modelViewer.status.preparingModel": "Preparing your model",
    "flutter.modelViewer.status.switchingModel": "Switching model",
  ...
  "nb": {
    ...
    "flutter.modelViewer.chat.programGenerationUnsupported": "Programgenerering er ikke koblet i Flutter ennå (programType={{programType}}).",
    "flutter.modelViewer.chat.quickPromptIntro": "Start med et raskt forslag eller still ditt eget spørsmål.",
    "flutter.modelViewer.chat.tapToOpenChat": "Trykk for å åpne chat",
    "flutter.modelViewer.history.stubReady": "Historikkpanelet er klart. Neste steg: koble til lagrede chatsesjoner.",
    "flutter.modelViewer.quickPrompt.recovery.label": "Tips for restitusjon",
    "flutter.modelViewer.quickPrompt.recovery.message": "Gi meg raske restitusjonstips for dette området.",
    "flutter.modelViewer.quickPrompt.trainArea.label": "Hvordan trene dette?",
    "flutter.modelViewer.quickPrompt.trainArea.message": "Hvordan bør jeg trene dette området?",
    "flutter.modelViewer.quickPrompt.whyHurt.label": "Hvorfor gjør dette vondt?",
    "flutter.modelViewer.quickPrompt.whyHurt.message": "Hvorfor gjør dette vondt?",
    "flutter.modelViewer.status.gettingReady": "Gjør klar alt",
    "flutter.modelViewer.status.loadError": "Kunne ikke laste modellen. Prøv igjen.",
    "flutter.modelViewer.status.loadingModel": "Laster anatomimodell",
    "flutter.modelViewer.status.preparingModel": "Forbereder modellen din",
    "flutter.modelViewer.status.switchingModel": "Bytter modell",
