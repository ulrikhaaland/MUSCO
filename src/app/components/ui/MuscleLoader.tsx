      ...
      if (pulseGroup) {
        ...
        pulsePaths.forEach((p, i) => {
          (p as SVGPathElement).style.animation =
            `pulseDraw 2s ease-in-out infinite alternate ${i * 30}ms`;
        });
      }
    }, 0);
...
-14 -37z"
        ...
        {/* loading caption */}
        <p className="mt-6 text-sm text-slate-300 text-center" aria-live="polite">
          {defaultMessage}
