...
export default function AddToHomescreen({
  ...
  useEffect(() => {
    ...
    const isSafariCheck = isIOS && /safari/.test(userAgent) && !/crios|fxios|opios|mercury/i.test(userAgent);
    ...
    let detectedBrowser: 'chrome' | 'edge' | 'firefox' | 'safari' | 'other' = 'other';
    if (isDesktopDevice) {
        ...
        return (
          <div className="mt-2 text-sm text-gray-300">
            ...
            <ol className="list-decimal pl-5 mt-1 space-y-1">
              ...
              <li>Click the install icon <span className="inline-block w-5">
        ...
        return (
          <div className="mt-2 text-sm text-gray-300">
            ...
            <ol className="list-decimal pl-5 mt-1 space-y-1">
              ...
              <li>If that option isn't available, bookmark this page instead</li>
            </ol>
          </div>
        );
      }
      ...
      return (
        <div className="mt-2 text-sm text-gray-300">
          ...
          <ol className="list-decimal pl-5 mt-1 space-y-1">
            ...
            <li>Look for &quot;Install&quot; or &quot;Add to Home Screen&quot; option</li>
            <li>Follow the on-screen instructions</li>
          </ol>
          <p className="mt-2 text-xs text-gray-400">
