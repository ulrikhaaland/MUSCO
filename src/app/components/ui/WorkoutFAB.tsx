...
interface WorkoutFABProps {
  ...
  disabled?: boolean;
  /** Show green checkmark state for completed workouts */
  completed?: boolean;
}

/**
 * Floating Action Button for starting/resuming workout sessions.
 * Three visual states: play (default), resume (active), checkmark (completed).
 */
    ...
    <button
      ...
      className={`
        ...
        ${disabled 
          ...
          : completed
            ? 'bg-emerald-600 hover:bg-emerald-500 hover:scale-105 active:scale-95 shadow-lg shadow-emerald-900/30'
            : isActive
      ...
      `}
      aria-label={completed ? t('workout.completed') : isActive ? t('workout.resumeWorkout') : t('workout.startWorkout')}
    >
